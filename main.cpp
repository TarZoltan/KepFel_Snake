	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			if (event.type == Event::Closed)
			{
				...
				//gonbok lenyomásának átalakítása iránnyá
		...
		window.clear(BG_color); //háttérszín beállítása


		if (!Dead) {


			//irány átalakítása mozgássá
		...
		else
		{
			...
			restart_txt.setString("Újrakezdéskez üss spacet-t");
